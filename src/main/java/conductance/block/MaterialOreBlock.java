...
public class MaterialOreBlock extends ConductanceBlock implements IMaterialOreBlock {
	...
	public MaterialOreBlock(final Properties properties, final Material material, final TaggedMaterialSet set, final MaterialOreType oreType) {
		super(properties);
	...
	public static BlockColor handleColorTint() {
		return (state, reader, pos, tintIndex) -> {
			if (state.getBlock() instanceof final IMaterialOreBlock block) {
				return block.getMaterial().getTintColor(tintIndex);
			}
			return -1;
		};
	}
