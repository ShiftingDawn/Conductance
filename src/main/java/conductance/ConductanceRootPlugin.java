...
public final class ConductanceRootPlugin implements IConductancePlugin {
	...
	public void registerMaterialOverrides(final MaterialOverrideMap overrides) {
		...
		overrides.add(NCMaterialOreTypes.ORE_TYPE_STONE, COAL, Blocks.COAL_ORE);
		overrides.add(NCMaterialOreTypes.ORE_TYPE_STONE, IRON, Blocks.IRON_ORE);
		overrides.add(NCMaterialOreTypes.ORE_TYPE_STONE, GOLD, Blocks.GOLD_ORE);
		overrides.add(NCMaterialOreTypes.ORE_TYPE_STONE, COPPER, Blocks.COPPER_ORE);
		overrides.add(NCMaterialOreTypes.ORE_TYPE_STONE, LAPIS, Blocks.LAPIS_ORE);
		overrides.add(NCMaterialOreTypes.ORE_TYPE_STONE, REDSTONE, Blocks.REDSTONE_ORE);
		overrides.add(NCMaterialOreTypes.ORE_TYPE_STONE, EMERALD, Blocks.EMERALD_ORE);
		overrides.add(NCMaterialOreTypes.ORE_TYPE_STONE, DIAMOND, Blocks.DIAMOND_ORE);
		overrides.add(NCMaterialOreTypes.ORE_TYPE_DEEPSLATE, COAL, Blocks.DEEPSLATE_COAL_ORE);
		overrides.add(NCMaterialOreTypes.ORE_TYPE_DEEPSLATE, IRON, Blocks.DEEPSLATE_IRON_ORE);
		overrides.add(NCMaterialOreTypes.ORE_TYPE_DEEPSLATE, GOLD, Blocks.DEEPSLATE_GOLD_ORE);
		overrides.add(NCMaterialOreTypes.ORE_TYPE_DEEPSLATE, COPPER, Blocks.DEEPSLATE_COPPER_ORE);
		overrides.add(NCMaterialOreTypes.ORE_TYPE_DEEPSLATE, LAPIS, Blocks.DEEPSLATE_LAPIS_ORE);
		overrides.add(NCMaterialOreTypes.ORE_TYPE_DEEPSLATE, REDSTONE, Blocks.DEEPSLATE_REDSTONE_ORE);
		overrides.add(NCMaterialOreTypes.ORE_TYPE_DEEPSLATE, EMERALD, Blocks.DEEPSLATE_EMERALD_ORE);
		overrides.add(NCMaterialOreTypes.ORE_TYPE_DEEPSLATE, DIAMOND, Blocks.DEEPSLATE_DIAMOND_ORE);
		overrides.add(NCMaterialOreTypes.ORE_TYPE_NETHERRACK, GOLD, Blocks.NETHER_GOLD_ORE);
		overrides.add(NCMaterialOreTypes.ORE_TYPE_NETHERRACK, NETHER_QUARTZ, Blocks.NETHER_QUARTZ_ORE);
