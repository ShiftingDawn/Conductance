...
public final class ConductanceRootPlugin implements IConductancePlugin {
	...
	public void registerMaterialOverrides(final MaterialOverrideMap overrides) {
		...
		overrides.add(NCMaterialTaggedSets.ORE_STONE, COAL, Blocks.COAL_ORE);
		...
		overrides.add(NCMaterialTaggedSets.ORE_DEEPSLATE, COAL, Blocks.DEEPSLATE_COAL_ORE);
		...
		overrides.add(NCMaterialTaggedSets.ORE_NETHERRACK, GOLD, Blocks.NETHER_GOLD_ORE);
		overrides.add(NCMaterialTaggedSets.ORE_NETHERRACK, NETHER_QUARTZ, Blocks.NETHER_QUARTZ_ORE);
