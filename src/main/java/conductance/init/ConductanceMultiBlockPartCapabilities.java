...
import static conductance.api.NCMultiBlockPartCapabilities.ENERGY_IN;
import static conductance.api.NCMultiBlockPartCapabilities.ENERGY_OUT;
...
final class ConductanceMultiBlockPartCapabilities {
	...
	private static void init(final RegisterMultiBlockPartCapabilityEvent event) {
		...
		ENERGY_IN = event.register("energy_in");
		ENERGY_OUT = event.register("energy_out");
	}
