...
public final class NCMachines {
	...
	public static Map<Tier, MachineType<?>> TRANSFORMER;
	...
	public static Map<Tier, MachineType<?>> OVERLOCKED_ENERGY_HATCHES;
	public static Map<Tier, MachineType<?>> OVERCLOCKED_DYNAMO_HATCHES;
