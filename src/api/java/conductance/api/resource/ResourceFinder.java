...
public interface ResourceFinder {
	...
	SafeOptional<ResourceLocation> getMaterialTexture(ResourceLocation textureSet, ResourceLocation textureType, @Nullable String pathPrefix, @Nullable String pathSuffix);

	SafeOptional<ResourceLocation> getMaterialItemModel(ResourceLocation textureSet, ResourceLocation textureType, @Nullable String pathPrefix, @Nullable String pathSuffix);

	SafeOptional<ResourceLocation> getMaterialBlockModel(ResourceLocation textureSet, ResourceLocation textureType, @Nullable String pathPrefix, @Nullable String pathSuffix);

	@Nullable
	ResourceLocation getCustomMaterialTexture(Material material, ResourceLocation textureType);
